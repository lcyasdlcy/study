...
void Dialog1::on_chkBoxUnder(bool checked)
{
...
void Dialog1::on_chkBoxItalic(bool checked)
{
    QFont font = txtEdit->font();
...
void Dialog1::on_chkBoxBold(bool checked)
{
    QFont font = txtEdit->font();
